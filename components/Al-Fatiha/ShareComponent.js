...
const ShareModel = ({
  ...
  let verse =
    engAyahState.name +
    ', آیت نمبر ' +
    verseItem.numberInSurah +
    ` \n` +
    ` \n` +
    'Surah ' +
    engAyahState.englishName +
    ' Verse no ' +
    verseItem.numberInSurah +
    `\n` +
    `\n` +
    selectedArabicAyahState.text +
    `\n` +
    `\n` +
    verseItem.text;
  ...
  // console.log(verseItem.numberInSurah);
  return (
    <>
      <View style={styles.shareBox}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              let obj = {
                number: verseItem.numberInSurah,
                text: verseItem.text,
                arabicTxt:selectedArabicAyahState.text,
                surahNumber:engAyahState.number,
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('SearchNextPrev', {
              surahNumber:engAyahState.number,
              verseNo:verseItem.numberInSurah
              })}>
            <IconFoundation
              name="page-search"
              style={{
